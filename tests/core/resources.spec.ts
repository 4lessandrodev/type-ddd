...
describe('all resources should be defined and available', () => {
	...
	const fakeValueE: IUseCase<any, any> = {} as unknown as IUseCase<any, any>;
	const fakeValueF: IBaseRepository<any, any> =
		{} as unknown as IBaseRepository<any, any>;
	const fakeValueG: IDomainEvent = {} as unknown as IDomainEvent;
	const fakeValueH: IHandle<any> = {} as unknown as IHandle<any>;
	const fakeValueI: IRepository<any, any, any> = {} as unknown as IRepository<
		any,
		any,
		any
	>;
