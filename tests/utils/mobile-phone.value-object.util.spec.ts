import { MobilePhoneValueObject } from '../../src/utils/mobile-phone.value-object';
...
describe('home-phone.value-object', () => {
	...
	it('should get value', ()=>{
		const valueObject = MobilePhoneValueObject.create('(71) 98254-1211').getResult();
		expect(valueObject.value).toBe('(71) 98254-1211');
	})

	it('should get only numbers value', ()=>{
		const valueObject = MobilePhoneValueObject.create('(71) 96254-1211').getResult();
		expect(valueObject.getOnlyNumbers()).toBe(71962541211);
	})

	it('should get only DDD number', ()=>{
		const valueObject = MobilePhoneValueObject.create('(71) 97254-1211').getResult();
