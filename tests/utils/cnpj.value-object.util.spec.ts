import { CNPJValueObject } from '../../lib/utils/cnpj.value-object';
...
describe('cnpj.value-object', () => {
	...
	it('should create a valid cnpj with special chars and remove special chars on get value', () => {
		...
		expect(valueObject.getResult().value).toBe('43909299000104');
	});

	it('should create a valid cnpj with special chars and remove special chars on get value', () => {
		const valueObject = CNPJValueObject.create('80.676.573/0001-79');
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('80676573000179');
	});

	it('should create a valid cnpj with special chars and remove special chars on get value', () => {
		const valueObject = CNPJValueObject.create('38331478000177');
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('38331478000177');
	});
	...
	it('should create a valid cnpj with special chars and remove special chars on get value', () => {
		...
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('24050723000163');
	});

	it('should create a valid cnpj with special chars and remove special chars on get value', () => {
		const valueObject = CNPJValueObject.create('93.853.653/0001-02');
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('93853653000102');
	});

	it('should create a valid cnpj with special chars and remove special chars on get value', () => {
		const valueObject = CNPJValueObject.create('99.410.207/0001-00');
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('99410207000100');
	});

	it('should format a cnpj to add special chars', () => {
		const valueObject =
			CNPJValueObject.create('20.798.751/0001-02').getResult();
	...
	it('should format a cnpj to add special chars', () => {
		const valueObject =
			CNPJValueObject.create('65.389.009/0001-81').getResult();
		valueObject.formatToCnpjPattern();
	...
	it('should format a cnpj to add special chars', () => {
		const valueObject =
			CNPJValueObject.create('02.470.431/0001-47').getResult();
		valueObject.formatToCnpjPattern();
	...
	it('should format a cnpj to add special chars and remove it later', () => {
		const valueObject =
			CNPJValueObject.create('62.412.404/0001-40').getResult();
		valueObject.formatToCnpjPattern();
	...
	it('should compare value on instance and provided value', () => {
		const valueObject =
			CNPJValueObject.create('22.606.062/0001-84').getResult();
	...
	it('should create a valid cnpj only numbers', () => {
		...
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('60105617000101');
	});
	...
	it('should create a valid cnpj only numbers', () => {
		...
		expect(valueObject.isSuccess).toBeTruthy();
		expect(valueObject.getResult().value).toBe('27729251000168');
	});
});
