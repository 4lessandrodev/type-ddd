import { PostalCodeValueObject } from '../../src/utils/postal-code.value-object';
...
describe('postal-code.value-object', () => {
	...
	it('should get value', ()=>{
		const valueObject = PostalCodeValueObject.create('75520140').getResult();
		expect(valueObject.value).toBe('75520140');
	})

	it('should get value without hyphen', ()=>{
		const valueObject = PostalCodeValueObject.create('75520-140').getResult();
		expect(valueObject.value).toBe('75520140');
	})
